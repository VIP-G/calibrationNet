...
from models.DatasetKitti360_2 import fetch_dataloader
...
def train(args):
    ...
    # model = nn.DataParallel(model, device_ids=[1])  # 多 GPU 训练，单个可以注释
    model.cuda()
    model.train()
    ...
    for epoch in range(starting_epoch, args.epochs + 1):
        ...
        for batch_idx, sample in enumerate(train_loader):
            ...
            # print("最大值：", torch.max(lidar_input))
            # print("最小值：", torch.min(lidar_input))
            # Run model
        ...
        # 若当前模型参数最优，记录当前模型权重
        # 若当前模型参数最优，记录当前模型权重
        val_loss = (logger_val.total_loss / val_set_size) * 1000
...
if __name__ == '__main__':
    ...
    parser.add_argument('--batch_size', type=int, default=25)  #12 炸#36
    parser.add_argument('--num_worker', type=int, default=1)
    # dataset 实例化参数
    parser.add_argument(
        '--data_folder',
        default= '/data_home/home/zhangguanghui/kitti360',
        help="")
    ...
    parser.add_argument('--val_sequence', type=str, default='03', help="")
    parser.add_argument('--img_shape', default=(384, 1280), help='图像统一大小')
    # ===============================================
    ...
    parser.add_argument(
        ...
        default=None)
        # help="")
    parser.add_argument('--name', default='test-0724-kitti360', help="权重给个名字")
    parser.add_argument('--dropout', default=0.0, help="")
    parser.add_argument('--gpus', type=int, nargs='+', default=[0, 1])  #多GPU
    # train 中 loss
    ...
    parser.add_argument('--log_frequency', type=int, default=20)  #10 
    parser.add_argument('--output', default='./outputkitti360/epoch0/03', help="")
    ...
    range_list = [20] #20,10,5,2,1
    checkpoints_list = {
        20:"checkpointskitti/r20_t1-5",
        10:"checkpointskitti/r10_t1",
         5:"checkpointskitti/r5_t0_5",
         2:"checkpointskitti/r2_t0_2",
         1:"checkpointskitti/r1_t0_1"
                        }
    max_r_list ={
        20:20.,
        10:10.,
    ...
    for idx in range_list:
        args.weight     = weights_list[idx]
        args.max_r       = max_r_list[idx]
        args.max_t      = max_t_list[idx]
        args.checkpoints = checkpoints_list[idx]
        print(f"idx:type:type{idx} -- {idx}")
        print(f"args.output: {args.checkpoints}")
        print("---------------------------------")
        # print(args.weight     )
        # print(args.max_r      )
        # print(args.max_t      )
